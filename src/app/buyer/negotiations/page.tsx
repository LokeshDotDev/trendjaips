...
export default async function BuyerNegotiationsPage() {
    ...
    <div className="space-y-6 font-sans">
      <div>
        <h1 className="text-xl sm:text-2xl font-black text-slate-900 tracking-tight flex items-center gap-2">
          <MessageSquare className="h-6 w-6 text-blue-600" /> Sourcing Negotiations
        </h1>
        <p className="text-xs sm:text-sm text-slate-500 font-medium mt-0.5">
          Communicate with Surat suppliers and counter commercial pricing offers.
        </p>
      </div>
      ...
      {negotiations.length === 0 ? (
        <div className="bg-white border border-slate-200 rounded-lg p-16 text-center text-slate-500 space-y-4 max-w-xl mx-auto">
          ...
          <p className="text-xs text-slate-500 max-w-sm mx-auto">
            Your threads will appear here once you submit a quote request (RFQ) for any fabric listing.
          </p>
          <Link
            href="/fabrics"
